<head>
	...
	<title>{{$title}} | Baso Builder</title>	
  <link rel="shortcut icon" type="image/x-icon"href="{{ asset('assets/img/baso.svg')}}">
	...
	<link rel="stylesheet" type="text/css" href="{{ asset('user-assets/css/ovstyle.css')}}">
</head>